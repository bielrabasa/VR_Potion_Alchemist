...
IL_00a6:
	{
		...
		bool L_28;
		L_28 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)127), NULL);
		if (L_28)
		{
			goto IL_00b7;
		}
	...
	{
		bool L_29;
		L_29 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(8, NULL);
		if (!L_29)
		{
			goto IL_00dd;
		}
...
IL_00ef:
	{
		...
		bool L_35;
		L_35 = Input_GetKeyDown_m0D59B7EBC3A782C9FBBF107FBCD4B72B38D993B3(((int32_t)275), NULL);
		if (!L_35)
		{
			goto IL_0101;
		}
...
IL_0101:
	{
		...
		bool L_36;
		L_36 = Input_GetMouseButtonDown_m33522C56A54C402FE6DED802DD7E53435C27A5DE(0, NULL);
		if (!L_36)
		{
			goto IL_014b;
		}
	}
	{
		...
		bool L_41;
		L_41 = Physics_Raycast_m1461ED9FFA5B4E83AA5F89436124F5FCF4D0714D(L_40, NULL);
		if (!L_41)
		{
			goto IL_014b;
		}
...
IL_014b:
	{
		...
		bool L_46;
		L_46 = Input_GetMouseButtonDown_m33522C56A54C402FE6DED802DD7E53435C27A5DE(1, NULL);
		if (L_46)
		{
			goto IL_015b;
		}
	...
	{
		bool L_47;
		L_47 = Input_GetMouseButtonDown_m33522C56A54C402FE6DED802DD7E53435C27A5DE(2, NULL);
		if (!L_47)
		{
			goto IL_0161;
		}
...
IL_0161:
	{
		...
		float L_48;
		L_48 = Input_GetAxis_m1F49B26F24032F45FB4583C95FB24E6771A161D4(_stringLiteralFC6687DC37346CD2569888E29764F727FAF530E0, NULL);
		V_0 = L_48;
		// if (scroll != 0f)
		float L_49 = V_0;
	...
	}
	{
		...
		L_52 = Vector3_get_forward_mEBAB24D77FC02FC88ED880738C3B1D47C758B3EB_inline(NULL);
		float L_53 = V_0;
		G_B28_0 = L_52;
		G_B28_1 = L_51;
...
IL_0197:
	{
		...
		L_54 = Vector3_op_Multiply_m516FE285F5342F922C6EB3FCB33197E9017FF484_inline(G_B30_1, G_B30_0, NULL);
...
#pragma clang diagnostic ignored "-Wunused-variable"
#endif
// System.Void CartoonFX.CFXR_Demo_Translate::Awake()
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void CFXR_Demo_Translate_Awake_m2E13757C3B4901D3D03E45F0EC35D92B2262E23F (CFXR_Demo_Translate_t95CB6CDBAE93F397B9CA608E9B233BAB8C7FB891* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_2;
		L_2 = Transform_get_position_m69CD5FA214FDAE7BB701552943674846C220FDE1(L_1, NULL);
		__this->___initialPosition_7 = L_2;
	}
...
// System.Void CartoonFX.CFXR_Demo_Translate::OnEnable()
...
{
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_0;
		L_0 = Component_get_transform_m2919A1D81931E6932C7F06D4C2F0AB8DDA9A5371(__this, NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_1 = __this->___initialPosition_7;
		NullCheck(L_0);
		Transform_set_position_mA1A817124BB41B685043DED2A9BA48CDF37C4156(L_0, L_1, NULL);
		// if (randomRotation)
		bool L_2 = __this->___randomRotation_5;
		if (!L_2)
		{
			goto IL_0042;
		}
	}
	{
		...
		L_6 = Vector3_op_Multiply_m516FE285F5342F922C6EB3FCB33197E9017FF484_inline(L_5, (360.0f), NULL);
		float L_7;
		L_7 = Random_get_value_m87344B352E686178D743B14C468EEE01757E9D43(NULL);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_8;
		L_8 = Vector3_Lerp_m57EE8D709A93B2B0FF8D499FA2947B1D61CB1FD6_inline(L_4, L_6, L_7, NULL);
		NullCheck(L_3);
...
// System.Void CartoonFX.CFXR_Demo_Translate::Update()
...
// System.Void CartoonFX.CFXR_Demo_Translate::.ctor()
